...
const ru = {
  ...
  event: {
    ...
    startsAt: 'Начало',
    endsAt: 'Окончание',
    recurring: 'Повторять событие',
    playerId: 'ID игрока для direct-attach',
    playerUsername: 'TG username игрока',
    inviteTargets: 'Приглашаемые TG usernames',
    addTarget: 'Добавить игрока',
    noInviteTargets: 'Добавьте минимум одного получателя приглашения',
    ...
    detail: 'О событии',
    detailLocation: 'Локация',
    detailDuration: 'Длительность',
    detailRecurring: 'Повторяющееся',
    actionReschedule: 'Перенести',
    actionCancel: 'Отменить',
    actionComplete: 'Завершить',
    actionShare: 'Поделиться ссылкой',
    rescheduleTitle: 'Перенести событие',
    rescheduleDate: 'Дата',
    rescheduleTimeStart: 'Начало',
    rescheduleTimeEnd: 'Конец',
    rescheduleConfirm: 'Сохранить',
    cancelConfirm: 'Подтвердить отмену',
    cancelHint: 'Это действие нельзя отменить',
...
const enPatch: Record<string, unknown> = {
  ...
  event: {
    ...
    playerUsername: 'Player TG username',
    inviteTargets: 'Invite targets (TG usernames)',
    addTarget: 'Add player',
    noInviteTargets: 'Add at least one invite target',
